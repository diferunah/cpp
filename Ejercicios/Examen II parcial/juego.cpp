#include <iostream>   //Paso 2 - creacion juego.cpp
#include <windows.h>
#include <conio.h>   //Paso 3 - Copiar includes a juego.cpp
#include <stdlib.h>
#include <time.h>

using namespace std;  //Paso 4 - copiar using namespace std

#define ARRIBA 72
#define IZQUIERDA 75
#define ABAJO 80      //Paso 5 - cortar/pegar definiciones a juego.cpp
#define DERECHA 77
#define ESC 27
...
int tam = 3;
int x=10, y=12;
int dir=3;           //Paso 6 - cortar/pegar variables definidas a juego.cpp
int xc=30, yc=20;
int xxc= 40, yyc=18;
int d;
int dif;
...
//Paso 7 - Cortar/Pegar funciones juego.cpp
...
void dibujarcuerpo()
{
	for(int i=1; i<tam;i++)
	{
		gotoxy(cuerpo[i][0],cuerpo[i][1]); cout<<"@"; //Paso 9 - cambiar "O" a "@"
	}
}
